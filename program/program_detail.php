            ...
            <section>
              <div id="div_main">
                ...
                <div class="buttons" id="myHeader">
                  <ul>
                    <li><label for="">서비스 설명</label> </li>
                    <li><label for="">가격정보</label> </li>
                    <li><label for="">전문가 이력</label> </li>
                    <li><label for="">커리큘럼</label> </li>
                    <li><label for="">취소및환불규정</label> </li>
                    <li><label for="">서비스 평가</label> </li>
                  </ul>
                </div>
                <div id="div_review">
