...
function getRating($id)
{
    global $conn;
    $rating = array();
    $likes_query = "SELECT COUNT(*) FROM rating_info WHERE b_code='레시피' and post_id = $id AND rating_action='like'";
...
function userLiked($post_id)
{
    global $conn;
    global $user_id;
    $sql = "SELECT * FROM rating_info WHERE b_code='레시피' and user_id='$user_id'
