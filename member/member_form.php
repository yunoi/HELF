        ...
        <div id="member_form">
          <form name="member_form" id="input_member_form" method="post">
            ...
            <input type="text" name="id" id="input_id" placeholder=" 아이디 입력 "> <br>
						...
						?>
						<input type="text" name="id" id="input_id" value="<?=$id?>" readonly> <br>
						<p id="input_id_confirm"></p>
            ...
            ?>
						  <input type="text" name="name" id="input_name" placeholder=" 이름 입력 "> <br>
						<?php
						}
						?>
            ...
            <div id="address">
              ...
              <p id="input_address_confirm"></p>
						...
						?>
						<div id="address">
              <input type="number" name="address_one" id="address_one" value="<?=$address1?>" onclick="address_input();">
              <input type="text" name="address_two" id="address_two"  value="<?=$address2?>" onclick="address_input();">
              <input type="text" name="address_three" id="address_three"  value="<?=$address3?>"> <br>
              <p id="input_address_confirm"></p>
            </div>
						<?php
							}
