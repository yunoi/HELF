        ...
        <div id="div_introduction">
          ...
          <p>안녕하세요 HELF 대표 <b><?=$mater?></b> 입니다. <br/> <br/>
            ...
            <div class="one">
              ...
              HELF는<br>
              <b>&nbsp;<span>Health</span>&nbsp;,&nbsp;<span>Life</span>&nbsp;,&nbsp;<span>Friends</span>&nbsp;</b><br>
              세 가지 의미를 모아서 만든 커뮤니티입니다.
                <div class="two">
                <br/>
                ”
              </div>
            ...
            건강한 삶을 위해 노력하는 여러분 곁에서 도와드리는 친구라는 의미입니다.<br/> <br/> <br/>

            운동을 같이할 친구를 찾기 힘들 때,<br/> <br/>
            원하는 시간과 원하는 장소에 맞추어서 같이 운동할 친구를 만들 수 있는<br/> <br/>
            그러한 장소를 찾았지만 처음 접하는 입문자분들에게는 그러한 손길이 닿기 힘든 경우가 많습니다.<br/> <br/> <br/>

            </p>
            <img src="./img/introduction2.jpg" width="800" alt=""><br/><br/>
            <p>

            HELF에서는 운동을 배우고자 하는 초심자들과 숙련자, 전문가들이 공존하며 <br/> <br/>
            그 만남이 딱딱하게 가르쳐주고 가르침을 받는 관계가 아닌 친구처럼 다가와<br/> <br/>
            친근하게 이야기하며 정보를 주고 받는 모습을 담고자 하였습니다.<br/> <br/><br/>
            ...
            감사합니다. 오늘도 건강하고, 활기차고, 힘찬 하루를 보내시기 바랍니다. <br/> <br/>
</p>
<br/>
<p>
            <div class="master">
