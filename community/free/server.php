...
if (isset($_POST['action'])) {
    ...
    case 'dislike':
         ...
         break;
    case 'unlike':
          $sql="DELETE FROM rating_info WHERE user_id='$user_id' AND post_id=$post_id AND b_code='자유게시판'";
          break;
    case 'undislike':
            $sql="DELETE FROM rating_info WHERE user_id='$user_id' AND post_id=$post_id AND b_code='자유게시판'";
      break;
...
function getRating($id)
{
    global $conn;
    $rating = array();
    $likes_query = "SELECT COUNT(*) FROM rating_info WHERE b_code='자유게시판' and post_id = $id AND rating_action='like'";
...
function userDisliked($post_id)
{
    global $conn;
    global $user_id;
    $sql = "SELECT * FROM rating_info WHERE b_code='자유게시판' and user_id='$user_id'
